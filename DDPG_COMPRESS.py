...
class DDPG(object):
    def __init__(self, a_dim, s_dim, a_bound,):
        ...
        self.saver.restore(self.sess, "Save/cartpole_g10_M1_m0.1_l0.5_tau_0.02_final.ckpt")  # 1 0.1 0.5 0.001
    ...
    def _build_a(self, s, reuse=None, custom_getter=None):
        ...
        with tf.variable_scope('Actor', reuse=reuse, custom_getter=custom_getter):
            net = tf.layers.dense(s, 128, activation=tf.nn.relu, name='l1', trainable=trainable)#原始是30
